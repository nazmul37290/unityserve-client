    ...
    <div className="relative h-[250px] w-[350px] mb-24">
      ...
      <div className="h-[200px] absolute bg-base-100 left-1/2 -translate-x-1/2 -bottom-[100px] w-[300px] hover:scale-110 hover:bg-light shadow-lg hover:text-base-100 rounded-3xl duration-1000">
        <div className=" p-4 md:p-4 ">
          <h1 className="text-xl font-bold text-gray-800 dark:text-base-100">
            {title}
          </h1>
          ...
          <div className="flex mt-2 item-center gap-4">
            <h1
              className={`bg-main rounded-r-md text-base-100 py-1 px-2 text-sm font-bold  dark:text-gray-200 `}
            >
              {category}
            </h1>
          ...
          <div className="flex justify-between mt-3 item-center">
            <Link to={`/postDetails/${_id}`}>
              <button className="px-2 py-1 text-xs font-bold text-base-100 bg-light uppercase transition-colors duration-300 transform rounded dark:bg-gray-700 hover:bg-gray-700 dark:hover:bg-gray-600 focus:outline-none focus:bg-gray-700 dark:focus:bg-gray-600">
                View Details
              </button>
            </Link>
          </div>
